...
const _propLink = (record, propName, content) =>
  m(`a[href=/strains/${record.recordId}/${propName}]`,
    { oncreate: m.route.link },
    content)
      ...
      m('.strain-detail',
        ...
        m(".list-group",
          [
            _labelProperty(
              'Testing Status',
              _propLink(record, 'testingStatus', _formatValue(record, 'testingStatus'))
            ),
            ...
            _row(
              [
                _labelProperty(
                  'THC Level',
                  _propLink(record, 'thcInput', _formatValue(record, 'thcInput'))
                ),
                _labelProperty(
                  'CBD Level',
                  _propLink(record, 'cbdInput', _formatValue(record, 'cbdInput'))
                )
              ]
            ),
            ...
            _row(
              [
                _labelProperty(
                  'Indica Level',
                  _propLink(record, 'indicaInput', _formatValue(record, 'indicaInput'))
                ),
                _labelProperty(
                  'Sativa Level',
                  _propLink(record, 'sativaInput', _formatValue(record, 'sativaInput'))
                ),
                _labelProperty(
                  'Rodellis Level',
                  _propLink(record, 'rodellisInput', _formatValue(record, 'rodellisInput'))
                )
              ]
            ),
          ]
