...
const _propLink = (record, propName, content) =>
  m(`a[href=/items/${record.recordId}/${propName}]`,
    { oncreate: m.route.link },
    content)
      ...
      m('.strain-detail',
        ...
        m(".list-group",
          [
            _labelProperty(
              'Item Name',
              _propLink(record, 'itemName', _formatValue(record, 'itemName'))
            ),
            ...
            _row(
              [
                _labelProperty(
                  'Item type',
                  _propLink(record, 'itemType', _formatValue(record, 'itemType'))
                ),
                _labelProperty(
                  'Quantity',
                  _propLink(record, 'quantity', _formatValue(record, 'quantity'))
                )
              ]
            ),
            ...
            _row(
              [
                _labelProperty(
                  'Unit of Measure',
                  _propLink(record, 'unitOfMeasure', _formatValue(record, 'unitOfMeasure'))
                ),
                _labelProperty(
                  'Item Category',
                  _propLink(record, 'itemCategory', _formatValue(record, 'itemCategory'))
                )
              ]
            ),
          ]
